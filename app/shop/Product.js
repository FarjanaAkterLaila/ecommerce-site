    ...
    return (
        ...
        <div className='flex flex-col justify-between lg:flex-row gap-16 lg:items-center mb-10'>
            <div className=' rounded-2xl flex flex-col gap-4 lg:w-2/4'>
                <img src={activeImg} alt="Product Image" className='w-[580px] h-[507px] aspect-square object-cover rounded-xl bg-[#f6f5fd] ' />
                <div className='flex flex-row justify-between h-24 mb-4'>
                    <img src={images.img1} alt="Thumbnail 1" className='w-24 h-24 rounded-md cursor-pointer bg-[#f6f5fd]' onClick={() => setActiveImage(images.img1)} />
                    <img src={images.img2} alt="Thumbnail 2" className='w-24 h-24 rounded-md cursor-pointer bg-[#f6f5fd]' onClick={() => setActiveImage(images.img2)} />
                    <img src={images.img3} alt="Thumbnail 3" className='w-24 h-24 rounded-md cursor-pointer bg-[#f6f5fd]' onClick={() => setActiveImage(images.img3)} />
                    <img src={images.img4} alt="Thumbnail 4" className='w-24 h-24 rounded-md cursor-pointer bg-[#f6f5fd]' onClick={() => setActiveImage(images.img4)} />
                </div>
            </div>
